...
public class SamplePrg {
	...
	public static void main(String[] args) throws IOException {
		...
		int t = scanInput.nextInt(); // Scanner has functions to read ints, longs, strings, chars, etc.
		for (int i = 0; i < t; ++i) {
		...
		int allTestCase = in.nextInt(); // Scanner has functions to read ints, longs, strings, chars, etc.
